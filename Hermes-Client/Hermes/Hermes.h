...
/*
 *   Command data structures which are used in communication with smm
 *
*/
typedef struct {
    uint64_t moduleBase;
...
/*
 *   Commands which are passed to the smm
 *
*/
typedef enum {
...
typedef struct {
    ...
    uint64_t dataPointer;                   // Pointer to data that should be used by smm
...
/*
 *   Result code that smm will write back
 *
*/
typedef enum {
