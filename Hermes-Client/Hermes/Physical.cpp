 ...
 *
 *   The function itself asks for further information (physical address and size to read).
 *   Function skips unknown memory which is not in the uefi memory map and thus deemed unsafe.
 *
*/
...
/*
 *   Function for writing arbitrary physical memory using smm.
 *   Asks for the following parameter:
 *       - packetBegin, pointer to the start of the memory mapping buffer
 *
 *   The function itself asks for further information (physical address, size to write and value to write).
 *   Function skips unknown memory which is not in the uefi memory map and thus deemed unsafe.
 *
*/
